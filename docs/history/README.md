...
| [controlm-loader-flow.md](controlm-loader-flow.md) | M3 ingestion baseline | 2026-06-11 loader-actual flow + schema baseline for review; §4 drift resolved 2026-07-15 (banner) — current description lives in `docs/design/controlm-ingestion-tdd.md` |
