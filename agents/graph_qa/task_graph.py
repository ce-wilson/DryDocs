...
run**, and UI snapshots are ephemeral. Persisting it to the then-`ddcontext`
(SYNTHESIZED, session-tagged, TTL-swept) was considered and DEFERRED; proposing
it again is a NEW gate, never a default. That database was retired at the G102
fold (2026-08-18), which changes where such a proposal would land and nothing
about the deferral — the ruling was about persisting at all, not about where.
