...
TEXT2CYPHER_USER = (
    ...
    "never return elementId() or id() — they are unstable across reloads and "
    "are rejected at registration, so return the node's own key property "
    "(job_id, folder_id, seal_id, ...) to identify a row; "
