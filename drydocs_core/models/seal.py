...
class SealApplicationRow(BaseModel):
    ...
    @field_validator(
        ...
        "investment_strategy",
        "creation_date",
        "actual_build_start_date",
        "actual_operate_date",
        "actual_decom_date",
        "actual_retirement_date",
        "planned_build_start_date",
        "planned_operate_date",
        "planned_decom_date",
        "planned_decom_date_chg_reason",
        "planned_retirement_date",
        "replaced_by_app_ids",
        "replacement_app_type",
        "retirement_type",
        "app_lob",
        "reporting_cio_lob",
        "reporting_cto_group",
        ...
        "using_lob_sub_lobs",
        "overall_risk_rating",
        "payment_card_industry_category",
        "info_classification",
        "strictest_rpo",
        "strictest_rto",
        "hosting_vendor",
        "overall_hosting_type",
        "platforms",
        "kapp",
        "provides_platforms",
        "programming_languages",
        "app_dev_responsibility",
        "app_dev_vendor_name",
        "source_code_vendor_name",
        "direct_access_vendor_name",
        "authentication_type",
        "authorization_type",
        "fine_grain_authorization_type",
        "not_external_facing_reason",
        "app_owner_sid",
        "app_owner_name",
        ...
        "last_certified_by_sid",
        "last_certified_date",
        "data_integrity",
        "externally_mandated_type",
        mode="before",
    )
    @classmethod
    ...
    @field_validator(
        ...
        "soc1_reportable",
        "ccar_reportable",
        "global_statutory_audit",
        "personal_info",
        "sensitive_personal_info",
        "client_confidential_info",
        "phi",
        "mnpi",
        "firm_owned_source_code",
        "internally_shared",
        "dev_app_only",
        "external_service",
        "tech_maintained",
        ...
        "third_party_direct_access",
        "vendor_engagements",
        "cpof_logical_deployment",
        "hvbe",
        "iwp_deployment",
        "external_network_connectivity",
        "external_network_exposure",
        "tier_0_1_or_2_network_assets",
