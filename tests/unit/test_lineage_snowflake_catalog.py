...
_DS_HEADER = [
    "DATASET_NAME",
    "DATASET_BUSINESSNAME",
    "DATASET_IDENTIFIER",
    "BUSINESS_DESCRIPTION_TEXT",
    "PUBLISHER_COMPANY_NAME",
    "PRODUCEDBY_APPLICATION_IDENTIFIER",
    "EMAIL_ADDRESS_TEXT",
...
_DIST_HEADER = [
    ...
    "DISTRIBUTION_NAME",
    "CONSUMABLE_INDICATOR",
    "PUBLICATIONMODE_TEXT",
    "REGISTRATION_SOURCE_SYSTEMNAME",
    "REGISTRATION_SOURCE_SYSTEMDATAASSET_IDENTIFIER",
    ...
    "TABLE_NAME",
    "TABLETYPE_TEXT",
    "LOGICALDATABASE_NAME",
    "DATABASE_NAME",
    "DATABASE_STORAGE_RESOURCE_URI_TEXT",
    "DATATECHNOLOGY_NAME",
    "DATABASESCHEMA_NAME",
    "FILE_NAME",
    "FILE_SYSTEM_NAME",
    "FILE_STORAGE_RESOURCE_URI_TEXT",
    "FILE_SYSTEMTYPE_TEXT",
    "DIRECTORY_NAME",
    "S3BUCKET_NAME",
    "STORAGE_RESOURCE_URI_TEXT",
    "S3DATAASSET_NAME",
]
...
def catalog_root(tmp_path: Path) -> Path:
    ...
    root.mkdir()
    _write_csv(
        root / "catalog_datasets_v.csv",
        _DS_HEADER,
        [
            # the union-dupe trio: ISO (oldest) -> unparseable -> DD-MON (latest)
            {
                "DATASET_NAME": "ACCOUNTS_CONFORMED",
                "DATASET_IDENTIFIER": DS_DPL,
            ...
            {
                "DATASET_NAME": "LEDGER_WAREHOUSE",
                "DATASET_BUSINESSNAME": "Ledger",
            ...
            {
                "DATASET_NAME": "MANUAL_LEGACY",
                "DATASET_IDENTIFIER": DS_NULL,
    ...
    _write_csv(
        root / "catalog_distributions_v.csv",
        _DIST_HEADER,
        [
            # (1) table shape — Snowflake, db + schema
            _dist(
                "dddd0001-0000-4000-8000-000000000001",
                TABLE_NAME="ACCOUNTS_CONFORMED",
                TABLETYPE_TEXT="TABLE",
                LOGICALDATABASE_NAME="ANALYTICS_DB",
                DATABASESCHEMA_NAME="CONF",
            ...
            _dist(
                ...
                FILE_SYSTEM_NAME="NOT INSTRUMENTED",
                FILE_SYSTEMTYPE_TEXT="HDFS",
                DIRECTORY_NAME="/data/refined/accounts",
            ...
            _dist("dddd0005-0000-4000-8000-000000000005", LOGICALDATABASE_NAME="NOT INSTRUMENTED"),
            # (6) contract violation: two shapes populated — counted, never guessed
            _dist(
                "dddd0006-0000-4000-8000-000000000006",
                TABLE_NAME="AMBIGUOUS_T",
                LOGICALDATABASE_NAME="X_DB",
                DATATECHNOLOGY_NAME="SNOWFLAKE",
                FILE_NAME="ambiguous.dat",
                DIRECTORY_NAME="/tmp/x",
                FILE_SYSTEMTYPE_TEXT="HDFS",
            ),
            # (7a/7b) union dupe — same distribution GUID, latest wins
            _dist(
                "dddd0007-0000-4000-8000-000000000007",
                TABLE_NAME="DUPED_T",
                LOGICALDATABASE_NAME="D_DB",
                DATABASESCHEMA_NAME="S1",
                DATATECHNOLOGY_NAME="TERADATA",
                TABLE_DESCRIPTION_TEXT="rev-old",
            ...
            _dist(
                ...
                DATABASESCHEMA_NAME="S1",
                DATATECHNOLOGY_NAME="TERADATA",
                TABLE_DESCRIPTION_TEXT="rev-latest",
                TIMESTAMP="2026-07-10 09:00:00",
            ),
            # (8) parent dataset GUID missing — staged, counted
            _dist(
                "dddd0008-0000-4000-8000-000000000008",
                DATASET_IDENTIFIER="",
                TABLE_NAME="ORPHAN_T",
                LOGICALDATABASE_NAME="O_DB",
                DATABASESCHEMA_NAME="S2",
                DATATECHNOLOGY_NAME="SNOWFLAKE",
            ),
        ],
    )
...
def test_duplicate_distribution_latest_wins(run) -> None:
    duped = next(r for r in run.distributions if r.distribution_guid.startswith("dddd0007"))
...
def test_glue_shaped_row_reuses_the_g41_canonical_namespace(run) -> None:
    ...
    glue = next(r for r in run.distributions if r.distribution_guid.startswith("dddd0002"))
...
def test_no_guid_and_no_parent_counted(run) -> None:
    ...
    orphan = next(r for r in run.distributions if r.distribution_guid.startswith("dddd0008"))
